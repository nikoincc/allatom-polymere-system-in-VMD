...
In VMD type "topo" to start ToopoTools and pless Enter(Win), Return(Mac)
...
Open "main.txt"[downloaded script](https://github.com/nikoincc/allatom-polymere-system-in-VMD)and chenge your name file.xyz and file.PDB  "set fname YOUR_FILE_NAME.xyz" | animate "write pdb PATH_TO_FILE.pdb"
